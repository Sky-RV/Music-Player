...
class _Rest_Client implements Rest_Client {
  ...
  @override
  Future<Latest_Music_Model> getMusicsByAlbum(id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'album_id': id};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<Latest_Music_Model>(Options(
  ...
  @override
  Future<Latest_Music_Model> getMusicByPlaylists(id) async {
    const _extra = <String, dynamic>{};
